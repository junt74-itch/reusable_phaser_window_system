...
export class ScrollbarRenderer {
  ...
  public update(): void {
    ...
    this.track.fillStyle(this.trackColor, 0.9);
    this.track.fillRect(layout.trackX, 0, layout.trackWidth, layout.contentHeight);
    this.thumb.fillStyle(this.thumbColor, 1);
    this.thumb.fillRect(layout.trackX, layout.thumbY, layout.trackWidth, layout.thumbHeight);
  }
